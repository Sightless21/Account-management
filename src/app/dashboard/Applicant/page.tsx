            ...
            <Card>
                <CardHeader className="flex flex-row gap-3 p-2 mt-2">
                    <div className="flex flex-row gap-3">
                        ...
                        <Button variant={"outline"} onClick={handleProbationPage}>Probationary Officer Table <TableOfContents /></Button>
                    </div>
                </CardHeader>
                <CardContent>
                    <ApplicantBoard data={applicants} searchQuery={searchQuery} selectProsition={selectedPosition} />
                </CardContent>
                <CardFooter>
